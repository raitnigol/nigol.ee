...
export const pohhuManifestoAfterCore: string[] = [
	"Together, they turned {{$.pohhu¥}} from a name into something people could point at. It became a loose system of artists, aliases, releases, arguments, jokes, designs, plans, and physical objects. A **collective**, a **label family**, a **friend group**, and a *cultural accident that became too real to ignore*.",
