...
export function PohhuLogoReveal() {
	return (
		<span
			className="pohhu-logo-reveal inline-flex items-baseline justify-center font-heading text-5xl font-extrabold tracking-tighter text-violet-400 md:text-6xl"
			aria-hidden="true"
		>
